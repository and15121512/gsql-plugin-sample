...
R_S_QUOTE: 'raw\'' -> pushMode(R_S_STRING);
R_D_QUOTE: 'raw"' -> pushMode(R_D_STRING);
R_B_QUOTE: 'raw`' -> pushMode(R_B_STRING);
...
T_RS_CLOSE_QUOTE: '\'' -> popMode;
//is overrided in visitTerminal in BaseVisitor!!!
T_RS_ESC: '\\\\n'| '\\\\r'| '\\\\t'  | '\\\\' | '\\$' | '\\"' | '\n' | '\\n' | '\\r' | '\r' | '\\t' | '\t';
//T_XS_EXP_INTERPOLATION: '${' -> pushMode(DEFAULT_MODE);
T_RS_EXP_INTERPOLATION: '${' -> pushMode(DEFAULT_MODE);
////in visitTerminal in BaseVisitor is substring(1)!!!
//T_XS_VAR_INTERPOLATION: '$' L_NAME_PART ('.' L_NAME_PART)*;
T_RS_OTHER: ~('\'')+;

mode R_D_STRING;

T_RD_CLOSE_QUOTE: '"' -> popMode;
//is overrided in visitTerminal in BaseVisitor!!!
T_RD_ESC: '\\\\n'| '\\\\r'| '\\\\t'  | '\\\\' | '\\$' | '\\"' | '\n' | '\\n' | '\\r' | '\r' | '\\t' | '\t';
//T_XS_EXP_INTERPOLATION: '${' -> pushMode(DEFAULT_MODE);
X_RD_EXP_INTERPOLATION: '${' -> pushMode(DEFAULT_MODE);
////in visitTerminal in BaseVisitor is substring(1)!!!
//T_XS_VAR_INTERPOLATION: '$' L_NAME_PART ('.' L_NAME_PART)*;
T_RD_OTHER: ~('"')+;
...
X_RB_CLOSE_QUOTE: '`' -> popMode;
//is overrided in visitTerminal in BaseVisitor!!!
T_RB_ESC: '\\\\n'| '\\\\r'| '\\\\t'  | '\\\\' | '\\$' | '\\"' | '\n' | '\\n' | '\\r' | '\r' | '\\t' | '\t';
//T_XS_EXP_INTERPOLATION: '${' -> pushMode(DEFAULT_MODE);
X_RB_EXP_INTERPOLATION: '${' -> pushMode(DEFAULT_MODE);
////in visitTerminal in BaseVisitor is substring(1)!!!
//T_XS_VAR_INTERPOLATION: '$' L_NAME_PART ('.' L_NAME_PART)*;
T_RB_OTHER: ~('`')+;
